...
# Installing packages & data
The data is downloaded from the Canadian government website and is available 
```{r pkg}
# Installing packages
library(knitr)
library(tidyverse)
...
## Map of CVID-19 mortality rates
...
rates_join %>%
  ...
  coord_fixed() +
  theme_mapcan() + 
  scale_fill_viridis_c(name = "Mortality rate / 1,000") +
